...
var appConfig = {
    ...
    domainChanged: false,
    init: function(){
        this.mediaUrl = 'https://api.printcart.com/v1/media';
    }
};
...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document', '$interval',
    ...
    $scope.loadGlobalTemplate = function(cid, withoutLoading){
        ...
        $http({
            method: 'GET',
            url: appConfig.mediaUrl + '/templates?limit='+ $scope.resource.globalTemplate.filter.perPage +'&category=' + cid + '&search=' + search + '&start=' + ($scope.resource.globalTemplate.filter.currentPage-1) * $scope.resource.globalTemplate.filter.perPage
    ...
    $scope.getGlobalTemplate = function(id, callback){
     ...
     $scope.getGlobalTemplateV2 = function(id, callback){
       
        $http({
            method: 'GET',
            url: appConfig.mediaUrl + '/templates/' + id 
        }).then(function(data) {
            data = data?.data?.data;
            if(angular.isDefined( data?.design) && data?.design){
    ...
    $scope.insertGlobalTemplate = function(id, $index){
        ...
        $scope.clearHistory();
        $scope.toggleStageLoading();
        $scope.getGlobalTemplateV2(id, function(data){
    ...
    $scope.getMedia = function(type, context){
        ...
        $http({
            method: 'GET',
            url: appConfig.mediaUrl + '/cliparts?limit=20&category=' + category + '&search=' + search + '&start=' + ($scope.resource[type].filter.currentPage-1) * 20
        }).then(function successCallback(response){
    ...
    $scope.addSvgFromMedia = function(art, $index){
        ...
        var url = appConfig.mediaUrl + '/cliparts/' + art.id;
